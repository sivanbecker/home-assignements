...
> Read `references/scaffolding.md` now for the exact directory layout, environment setup, and config file contents to use when creating these files.
...
Directory layout, environment requirements, and config file stubs are in `references/scaffolding.md`.
